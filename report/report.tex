...
\begin{figure}[H]
	...
	\begin{subfigure}[H]{.4\textwidth}
		\includegraphics[width=\textwidth]{../113chart.png}
		\caption*{Figure 2}
	\end{subfigure}
\end{figure}
